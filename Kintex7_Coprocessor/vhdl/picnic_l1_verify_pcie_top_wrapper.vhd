...
--Date        : Wed Mar  6 14:22:39 2019
--Host        : tug-swl-c190.tugraz.at running 64-bit Debian GNU/Linux 9.7 (stretch)
--Command     : generate_target picnic_l1_verify_pcie_top_wrapper.bd
--Design      : picnic_l1_verify_pcie_top_wrapper
...
entity picnic_l1_verify_pcie_top_wrapper is
  port (
...
end picnic_l1_verify_pcie_top_wrapper;

architecture STRUCTURE of picnic_l1_verify_pcie_top_wrapper is
  component picnic_l1_verify_pcie_top is
  port (
    pci_express_x8_rxn : in STD_LOGIC_VECTOR ( 7 downto 0 );
    pci_express_x8_rxp : in STD_LOGIC_VECTOR ( 7 downto 0 );
    pci_express_x8_txn : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component picnic_l1_verify_pcie_top;
begin
picnic_l1_verify_pcie_top_i: component picnic_l1_verify_pcie_top
     port map (
