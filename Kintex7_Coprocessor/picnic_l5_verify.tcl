...
#
# picnic_l5_verify.tcl: Tcl script for re-creating project 'picnic_l5_verify'
#
# Generated by Vivado on Mon Mar 25 10:30:05 CET 2019
...
#
# 1. This project restoration tcl script (picnic_l5_verify.tcl) that was generated.
#
#*****************************************************************************************

# Set the project name
set _xil_proj_name_ "picnic_l5_verify"
...
set script_file "picnic_l5_verify.tcl"
...
set files [list \
 [file normalize "./vhdl/picnic_l5_verify_pcie_top_wrapper.vhd" ]\
]
...
set file "vhdl/picnic_l5_verify_pcie_top_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "picnic_l5_verify_pcie_top_wrapper" -objects $obj
...
# Proc to create BD picnic_l5_verify_pcie_top
proc cr_bd_picnic_l5_verify_pcie_top { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name picnic_l5_verify_pcie_top
  ...
  user.org:user:AXIS_picnic_l5_verify:1.0\
  ...
  # Create instance: AXIS_picnic_l5_verify_0, and set properties
  set AXIS_picnic_l5_verify_0 [ create_bd_cell -type ip -vlnv user.org:user:AXIS_picnic_l5_verify:1.0 AXIS_picnic_l5_verify_0 ]
  ...
  connect_bd_intf_net -intf_net AXIS_Byte_Reverse_0_M00_AXIS [get_bd_intf_pins AXIS_Byte_Reverse_0/M00_AXIS] [get_bd_intf_pins AXIS_picnic_l5_verify_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net AXIS_picnic_l5_verify_0_M00_AXIS [get_bd_intf_pins AXIS_Byte_Reverse_1/S00_AXIS] [get_bd_intf_pins AXIS_picnic_l5_verify_0/M00_AXIS]
  ...
  connect_bd_net -net AXIS_picnic_l5_verify_0_pdo_last [get_bd_pins AXIS_picnic_l5_verify_0/pdo_last] [get_bd_pins xdma_0/s_axis_c2h_tlast_0]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins AXIS_Byte_Reverse_0/rst] [get_bd_pins AXIS_Byte_Reverse_1/rst] [get_bd_pins AXIS_picnic_l5_verify_0/rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins AXIS_Byte_Reverse_0/clk] [get_bd_pins AXIS_Byte_Reverse_1/clk] [get_bd_pins AXIS_picnic_l5_verify_0/clk] [get_bd_pins xdma_0/axi_aclk]
...
# End of cr_bd_picnic_l5_verify_pcie_top()
cr_bd_picnic_l5_verify_pcie_top ""
set_property IS_MANAGED "0" [get_files picnic_l5_verify_pcie_top.bd ]
set_property REGISTERED_WITH_MANAGER "1" [get_files picnic_l5_verify_pcie_top.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files picnic_l5_verify_pcie_top.bd ]
